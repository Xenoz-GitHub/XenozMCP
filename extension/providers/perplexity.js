const NVProvider = (() => {
  "use strict";
  const siteName = "Perplexity";
  let lastResponse = "";
  let diagFn = null;

  function getLatestResponse() {
    const messages = document.querySelectorAll('[class*="message"], [data-testid*="answer"]');
  ...
  function isGenerating() {
    return !!document.querySelector('[class*="loading"], [class*="generating"]');
  }
